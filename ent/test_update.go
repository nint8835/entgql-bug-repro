...
func (tu *TestUpdate) check() error {
	if v, ok := tu.mutation.Test(); ok {
		if err := test.TestValidator(v); err != nil {
...
func (tu *TestUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Test(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeEnum,
			Value:  value,
			Column: test.FieldTest,
		})
	}
...
func (tuo *TestUpdateOne) sqlSave(ctx context.Context) (_node *Test, err error) {
	...
	if value, ok := tuo.mutation.Test(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeEnum,
			Value:  value,
			Column: test.FieldTest,
