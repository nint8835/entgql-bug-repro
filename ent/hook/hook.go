...
// The OtherTestFunc type is an adapter to allow the use of ordinary
// function as OtherTest mutator.
type OtherTestFunc func(context.Context, *ent.OtherTestMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OtherTestFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.OtherTestMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OtherTestMutation", m)
	}
	return f(ctx, mv)
}
