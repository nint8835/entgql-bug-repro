...
func (ot *OtherTest) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(ot.Test); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "othertest.Test",
...
func (t *Test) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(t.Test); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "test.Test",
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	switch table {
	case othertest.Table:
		n, err := c.OtherTest.Query().
			Where(othertest.ID(id)).
			CollectFields(ctx, "OtherTest").
			Only(ctx)
		if err != nil {
			return nil, err
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	switch table {
	case othertest.Table:
		nodes, err := c.OtherTest.Query().
			Where(othertest.IDIn(ids...)).
			CollectFields(ctx, "OtherTest").
			All(ctx)
		if err != nil {
			return nil, err
