...
type OtherTestMutation struct {
	...
	oldValue      func(context.Context) (*OtherTest, error)
	predicates    []predicate.OtherTest
}

var _ ent.Mutation = (*OtherTestMutation)(nil)

// othertestOption allows management of the mutation configuration using functional options.
type othertestOption func(*OtherTestMutation)

// newOtherTestMutation creates new mutation for the OtherTest entity.
func newOtherTestMutation(c config, op Op, opts ...othertestOption) *OtherTestMutation {
	m := &OtherTestMutation{
		config:        c,
		op:            op,
		typ:           TypeOtherTest,
...
// withOtherTestID sets the ID field of the mutation.
func withOtherTestID(id int) othertestOption {
	return func(m *OtherTestMutation) {
		var (
			err   error
			once  sync.Once
			value *OtherTest
		)
		m.oldValue = func(ctx context.Context) (*OtherTest, error) {
			once.Do(func() {
				if m.done {
					err = fmt.Errorf("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().OtherTest.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withOtherTest sets the old OtherTest of the mutation.
func withOtherTest(node *OtherTest) othertestOption {
	return func(m *OtherTestMutation) {
		m.oldValue = func(context.Context) (*OtherTest, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// OldTest returns the old "test" field's value of the OtherTest entity.
// If the OtherTest object wasn't provided to the builder, the object is fetched from the database.
...
func (m *OtherTestMutation) Fields() []string {
	...
	if m.test != nil {
		fields = append(fields, othertest.FieldTest)
	}
	return fields
}
...
func (m *OtherTestMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	return nil, fmt.Errorf("unknown OtherTest field %s", name)
}
...
func (m *OtherTestMutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown OtherTest field %s", name)
}
...
func (m *OtherTestMutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown OtherTest numeric field %s", name)
}
...
func (m *OtherTestMutation) ClearField(name string) error {
	return fmt.Errorf("unknown OtherTest nullable field %s", name)
}
...
func (m *OtherTestMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown OtherTest unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *OtherTestMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown OtherTest edge %s", name)
}
...
// OldTest returns the old "test" field's value of the Test entity.
...
func (m *TestMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.test != nil {
		fields = append(fields, test.FieldTest)
	}
	return fields
}
