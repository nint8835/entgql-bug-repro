...
func (otd *OtherTestDelete) Where(ps ...predicate.OtherTest) *OtherTestDelete {
...
func (otd *OtherTestDelete) sqlExec(ctx context.Context) (int, error) {
...
func (otdo *OtherTestDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{othertest.Label}
	default:
		return nil
	}
}
