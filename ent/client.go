...
import (
	...
	"github.com/nint8835/entgql-bug-repro/ent/migrate"
...
func (c *Client) init() {
	...
	c.OtherTest = NewOtherTestClient(c.config)
...
func NewOtherTestClient(c config) *OtherTestClient {
	return &OtherTestClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `othertest.Hooks(f(g(h())))`.
func (c *OtherTestClient) Use(hooks ...Hook) {
	c.hooks.OtherTest = append(c.hooks.OtherTest, hooks...)
}

// Create returns a create builder for OtherTest.
func (c *OtherTestClient) Create() *OtherTestCreate {
	mutation := newOtherTestMutation(c.config, OpCreate)
	return &OtherTestCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}
...
func (c *OtherTestClient) CreateBulk(builders ...*OtherTestCreate) *OtherTestCreateBulk {
	return &OtherTestCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for OtherTest.
func (c *OtherTestClient) Update() *OtherTestUpdate {
	mutation := newOtherTestMutation(c.config, OpUpdate)
	return &OtherTestUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}
...
func (c *OtherTestClient) UpdateOneID(id int) *OtherTestUpdateOne {
	mutation := newOtherTestMutation(c.config, OpUpdateOne, withOtherTestID(id))
	return &OtherTestUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for OtherTest.
func (c *OtherTestClient) Delete() *OtherTestDelete {
	mutation := newOtherTestMutation(c.config, OpDelete)
	return &OtherTestDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}
...
func (c *OtherTestClient) DeleteOneID(id int) *OtherTestDeleteOne {
	builder := c.Delete().Where(othertest.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &OtherTestDeleteOne{builder}
}
...
func (c *OtherTestClient) Get(ctx context.Context, id int) (*OtherTest, error) {
	return c.Query().Where(othertest.ID(id)).Only(ctx)
}
